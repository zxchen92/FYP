...
urlpatterns = [
	...
	path('createfood',views.create_food,name='createfood'),
	path('createpromotion',views.create_promotion,name='createpromotion'),
	path('datainsights', views.data_insight, name='datainsights'),
	path('deletefood/<int:food_id>',views.delete_food,name='deletefood'),
	path('deletepromotion/<int:promotion_id>', views.delete_promotion, name='deletepromotion'),
	...
	path('searchfood',views.search_food,name='searchfood'),
	...
	path('updatefood/<int:food_id>', views.update_food, name = 'updatefood'),
	...
	path('viewfood/<int:food_id>', views.view_food, name = 'viewfood'),
